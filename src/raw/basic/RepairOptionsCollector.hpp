...
#ifndef REPAIROPTIONSCOLLECTOR_HPP
#define REPAIROPTIONSCOLLECTOR_HPP

#include "raw/basic/CollectorDecorator.hpp"


class RepairOptionsCollector : public CollectorDecorator
{
public:
...
#endif // REPAIROPTIONSCOLLECTOR_HPP
