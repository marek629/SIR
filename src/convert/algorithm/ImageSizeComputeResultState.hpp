...
#ifndef IMAGESIZECOMPUTERESULTSTATE_HPP
#define IMAGESIZECOMPUTERESULTSTATE_HPP

class ImageSizeComputeResultState
{
public:
    ...
    void setCanNotWriteTemporaryImageFile();

    int toInt() const;

    bool isInitialState() const;
    bool isImageFileSaved() const;

    bool isEnlargeDenied() const;
...
#endif // IMAGESIZECOMPUTERESULTSTATE_HPP
