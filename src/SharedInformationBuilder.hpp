...
#ifndef SHAREDINFORMATIONBUILDER_HPP
#define SHAREDINFORMATIONBUILDER_HPP
...
{
public:
    SharedInformationBuilder(const SharedInformation &info);
...
#endif // SHAREDINFORMATIONBUILDER_HPP
